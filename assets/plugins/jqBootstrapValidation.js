      ...
      init : function( options ) {
        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            //                                                MINCHECKED
            // ---------------------------------------------------------
            if ($this.attr("minchecked") !== undefined && $this.attr("type").toLowerCase() === "checkbox") {
              message = "Not enough options checked; Minimum of 1 required<!-- data-validation-minchecked-message to override -->";
